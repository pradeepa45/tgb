            ...
            <div class="grids-area-hny main-cont-wthree-fea row">
                <div class="col-lg-3 col-md-5 px-lg-2 mt-lg-0 mt-3">
                    <div class="area-box color-1">
                        ...
                        <h4><a href="blankpage.html" class="title-head">Find a Tutor</a></h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-5 px-lg-2 mt-lg-0 mt-3 ">
                    <!--mt-md-5 mt-3-->
                    <div class="area-box color-2">
                        ...
                        <h4><a href="blankpage.html" class="title-head">Micro Courses</a></h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-5 px-lg-2 mt-lg-0 mt-3">
                    <div class="area-box color-3">
                        <i class="fa fa-comments" aria-hidden="true"></i>
                        <h4><a href="blankpage.html" class="title-head">Latest Updates</a></h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-5 px-lg-2 mt-lg-0 mt-3">
                    <div class="area-box color-4">
                        <i class="fa fa-check-circle" aria-hidden="true"></i>
                        <h4><a href="contact.html" class="title-head">Review</a></h4>
                    </div>
                </div>
            </div>
        </div>
